...
import { apiSlice, useGetSessionQuery, useLogoutMutation } from '../store/api'
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ user: session?.user ?? null, isLoading: shouldCheckSession && isLoading, loginWithDiscord, logout }}>
      {children}
